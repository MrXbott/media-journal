    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, default='default/default_user_photo.jpg', null=True, upload_to='photo/')),
                ...
                ('following', models.ManyToManyField(related_name='followers', through='accounts.Contact', to='accounts.user')),
            ],
            options={
